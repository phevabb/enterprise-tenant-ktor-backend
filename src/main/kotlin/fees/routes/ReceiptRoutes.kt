...
fun Route.receiptRoutes() {
        ...
        // GET /api/receipts/{id}/print  -> printable HTML
        get("{id}/print") {
            val id = call.parameters["id"]?.toIntOrNull()
                ?: return@get call.respondText("Invalid id", status = HttpStatusCode.BadRequest)

            val r = ReceiptRepository.findById(id)
                ?: return@get call.respondText("Receipt not found", status = HttpStatusCode.NotFound)
            ...
            val html = """
                ...
                <body>
                  <div class="box">
                    <div class="hdr">
                      <div>
                        <div class="brand">KING OF GLORY PREPARATORY SCHOOL</div>
    ...
    get("{id}/pdf") {
        ...
        val pdfBytes = ReceiptPdfGenerator.buildPdf(r)
